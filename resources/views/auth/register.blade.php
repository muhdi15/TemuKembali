...
<head>
    ...
    <title>Daftar - TemuKembali</title>
        ...
        <form action="{{ route('register.post') }}" method="POST" class="mt-4">
            ...
            <div class="mb-3">
                <label for="name" class="form-label">
                    <i class="bi bi-person-lines-fill me-1"></i> Nama Lengkap
                </label>
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="form-label">
                    <i class="bi bi-shield-lock-fill me-1"></i> Konfirmasi Sandi
                </label>
            ...
            <p class="text-center mt-4 text-light text-opacity-80">
                Sudah punya akun?
                <a href="{{route('login.form')}}" class="fw-semibold">Masuk di sini</a>
            </p>
        </form>
    </div>
